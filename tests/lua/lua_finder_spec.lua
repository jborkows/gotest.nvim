...
describe("parsing example", function()
	...
	it("test found case", function()
		...
		local testA = luaCore.find(0, core.TestIdentifier:new("lua/lua_finder_spec", "test A"))
		assert(testA == 4, "Should found test A")
	end)

	it("test found second case", function()
		vim.cmd("e tests/lua/lua_finder_spec.lua")
		local testB = luaCore.find(0, core.TestIdentifier:new("lua/lua_finder_spec", "test B"))
		assert(testB == 7, "Should found test B")
	end)

	it("should not found random test", function()
		vim.cmd("e tests/lua/lua_finder_spec.lua")
		local notExistingTest = luaCore.find(0, core.TestIdentifier:new("lua/lua_finder_spec", "test C"))
